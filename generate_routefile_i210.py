...
def generate_routefile():
	...
	upper_branch_arrival_rate_list = [0.2, 1.5, 0.5]
	...
	routes=open("./Nguyen-Dupuis/i210.rou.xml", "w")
...
<routes>
	...
	# 	for j in range(1,25):
	# 		if i!=j:
	# 			print("""    <route id="route""" +str(i)+"to"+str(j) """" edges="start"""+str(i) + " end"+str(j) + """" />""")
	...
	# 	for j in range(1,25):
	# 		if i!=j:
	# 			depart_time_list=generateDepartTime(upper_branch_arrival_rate_list,2,CAV_ratio)
	# 			fromLoc="start"+str(i)
	# 			toLoc="end"+str(j)
	# 			collectFiles(depart_time_list,routes,fromLoc,toLoc,allTrips)\
	# depart_time_list=generateDepartTime(upper_branch_arrival_rate_list,50,CAV_ratio)
	# fromLoc="start24"
	# toLoc="end6"
	# collectFiles(depart_time_list,routes,fromLoc,toLoc,allTrips)

	depart_time_list=generateDepartTime(upper_branch_arrival_rate_list,200,CAV_ratio)
	fromLoc="start1"
	toLoc="end5"
	collectFiles(depart_time_list,routes,fromLoc,toLoc,allTrips)
	...
	depart_time_list=generateDepartTime(upper_branch_arrival_rate_list,80,CAV_ratio)
	fromLoc="start1"
	toLoc="end2"
	collectFiles(depart_time_list,routes,fromLoc,toLoc,allTrips)
	...
	depart_time_list=generateDepartTime(upper_branch_arrival_rate_list,40,CAV_ratio)
	fromLoc="start4"
	toLoc="end10"
	collectFiles(depart_time_list,routes,fromLoc,toLoc,allTrips)
	...
	depart_time_list=generateDepartTime(upper_branch_arrival_rate_list,120,CAV_ratio)
	fromLoc="start5"
	toLoc="end7"
	collectFiles(depart_time_list,routes,fromLoc,toLoc,allTrips)
	
	depart_time_list=generateDepartTime(upper_branch_arrival_rate_list,360,CAV_ratio)
	fromLoc="start8"
	toLoc="end9"
	collectFiles(depart_time_list,routes,fromLoc,toLoc,allTrips)

	depart_time_list=generateDepartTime(upper_branch_arrival_rate_list,280,CAV_ratio)
	fromLoc="start8"
	toLoc="end13"
	collectFiles(depart_time_list,routes,fromLoc,toLoc,allTrips)
