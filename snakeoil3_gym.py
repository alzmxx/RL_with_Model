            ...
            try:
                ...
                if n_fail < 0:
                    ...
                    if self.vision is False:
                        ...
                        #os.system('torcs -nofuel -nodamage -nolaptime -r /home/xiongxi/.torcs/config/raceman/quickrace.xml &')
                    time.sleep(1.0)
...
def drive_example(c):
    ...
    # Steer To Corner
    R['steer']= S['angle']*20 / PI
    # Steer To Center
    R['steer']-= S['trackPos']*.30
    #print(R['steer'])
    # Throttle Control
    if S['speedX'] < target_speed - abs((R['steer']*200)):
        R['accel']+= .01
        #print(R['accel'])
